# Awesome Secure Program Synthesis
...
- [Bound Propagation meets Constraint Simplification: Improving Logic-based XAI for Neural Networks (Gomes et al.) (2026/03)](https://arxiv.org/abs/2603.01923v1)
- [Towards Real-World Industrial-Scale Verification: LLM-Driven Theorem Proving on seL4 (Zhang et al.) (2026/02)](https://arxiv.org/abs/2602.08384v1)
- [Lean Finder: Semantic Search for Mathlib That Understands User Intents (Lu et al.) (2026/02)](https://arxiv.org/abs/2510.15940v1)
- [Formal methods for safety-critical machine learning: a systematic literature review (Newcomb, Ochoa) (2026/02)](https://www.frontiersin.org/journals/artificial-intelligence/articles/10.3389/frai.2026.1749956/full)
- [Imandra CodeLogician: Neuro-Symbolic Reasoning for Precise Analysis of Software Logic (Lin et al.) (2026/01)](https://arxiv.org/abs/2601.11840v2)
- [Autonomous Agents and Policy Compliance: A Framework for Reasoning About Penalties (Tummala, Inclezan) (2025/12)](https://arxiv.org/abs/2512.03931v1)
- [A Solver-in-the-Loop Framework for Improving LLMs on Answer Set Programming for Logic Puzzle Solving (Schrader et al.) (2025/12)](https://arxiv.org/abs/2512.17093v1)
- [Agentic Property-Based Testing: Finding Bugs Across the Python Ecosystem (Maaz et al.) (2025/10)](https://arxiv.org/abs/2510.09907)
- [Approximately Aligned Decoding (Melcer et al.) (2025/10)](https://arxiv.org/abs/2410.01103v2)
- [ShinkaEvolve: Towards Open-Ended And Sample-Efficient Program Evolution (Lange et al.) (2025/09)](https://arxiv.org/pdf/2509.19349)
...
- [How I Learnt to Stop Worrying and Love AI](https://www.tweag.io/blog/2026-02-12-doctor-xaelong/)
